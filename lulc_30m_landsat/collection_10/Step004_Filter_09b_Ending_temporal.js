...
//Atencção este script foi ajustado para virar o filtro 11 com especificidade para tratar
// da classe 11, mas foi salvo com os criterios desse filtro, com isso perdeu-se a memoria do filtro original....
//resgatar
// ***************************************************************************************
...
print('aa') 
var bioma = "PAMPA"
var versionOut = version + '_final1'
var versionIn = version + '_gran4'
...
for (var i_regiao=0;i_regiao<regioes.length; i_regiao++){
  ...
  filtered = mask3last(22, filtered)
  ...
  var ordem_exec = [22, 21, 11, 3, 12, 33];
