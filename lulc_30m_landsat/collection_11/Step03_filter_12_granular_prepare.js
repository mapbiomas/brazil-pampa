...
var versionIn = version + '_umid_plus'
...
for (var i_regiao=0;i_regiao<regioes.length; i_regiao++){
 ...
 // var pixelArea = ee.Image.pixelArea();
  ...
  // para a regiao 1 nos anos 1998 e 1999 foi necessario baixar o limiar pois tinha muitas geometrias..
  //  var con_ano = ano_21.connectedPixelCount(81,false).selfMask()
  //  con_ano = con_ano.updateMask(con_ano.lt(81))
 ...
 //   print('f',f)
  ...
  ' PAMPA_obj_' + ano + '_r' + regiao + '_v' + version, 
   'projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/GENERAL/SAMPLES/PAMPA/SEGMENTS/obj_class21_ano_' 
