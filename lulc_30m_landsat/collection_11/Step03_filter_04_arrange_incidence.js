...
for (var i_regiao=0;i_regiao<regioes.length; i_regiao++){
  ...
  Map.addLayer(image_incidence, {}, "n incidents");
  
  image_incidence = image_incidence.addBands(image_incidence.mask(image_incidence.gt(10)).where(image_incidence.gt(6),1).rename('reclass1'))
  image_incidence = image_incidence.addBands(image_incidence.select('reclass1').connectedPixelCount(100,false).rename('connect'))
  ...
  Map.addLayer(image_incidence, {}, "incidents gt10");
