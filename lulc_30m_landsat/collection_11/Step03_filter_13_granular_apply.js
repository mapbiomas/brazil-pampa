...
var version = '07', regioes =  [1]//[3,4,5,7]
//var version = '12', regioes = [2]
var col = '11'
var bloco = '85-25'  

var versionOut = version + '_granular'
var versionIn = version + '_umid_plus'// para versao 2 é o _esp_pos_inci
...
for (var i_regiao=0;i_regiao<regioes.length; i_regiao++){
  ...
  for (var i_ano=0;i_ano<anos.length; i_ano++){
    ...
    var objcts_ano = ee.FeatureCollection('projects/mapbiomas-brazil/assets/LAND-COVER/COLLECTION-11/GENERAL/SAMPLES/PAMPA/SEGMENTS/obj_class21_ano_' 
