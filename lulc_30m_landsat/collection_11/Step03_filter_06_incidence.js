...
var col = 11
var bioma = "PAMPA"
var versionOut = versionout +  '_inci'
var versionIn = versionout + '_freq'
...
for (var i_regiao=0;i_regiao<regioes.length; i_regiao++){
  ...
  var image_incidence_outros = ee.Image(dir_filtros+ '0' + String(regiao) +'_RF_col'+col+'_' + bloco +'_v' +  versionIncidentes);
