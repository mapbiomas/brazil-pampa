...
var regioes = [1,2,3,4,5,6,7//2,3,4,5,6
  //1,2,3,4,5,6,7
  ] 
...
for (var i_regiao=0;i_regiao<regioes.length; i_regiao++){
  ...
  var col7 =  ee.Image(dirout + '0' + String(regiao) +'_Emb_RF17a25_v' + vesion_in)
  ...
  var nivel0_2022 = class_nivel0.select('classification_2025')
  var nivel0_2021 = class_nivel0.select('classification_2024')
  ...
  var ruido_desmat21 = col7.select('classification_2024').updateMask(desmat1ha)
  ...
  var ruido_regen21 = col7.select('classification_2024').updateMask(regen1ha)
  ...
  Export.image.toAsset({
      ...
      'description':  '0' + String(regiao) +'_Emb_RF17a25_v' + versao_out,
      'assetId': dirout + '0' + String(regiao) +'_Emb_RF17a25_v' + versao_out,
      "scale": 10,
      "pyramidingPolicy": {
          '.default': 'mode'
      },
