...
# About
This folder contains the scripts to classify and post-process the Pampa Biome to produce the land use and land cover annual maps of Brazil at 10 meters resolution using Sentinel-2 satellite images covering the period from 2017 to 2025.
 
We recommend that you read the MapBiomas Appendix of the Algorithm Theoretical Basis Document ([ATBD](https://brasil.mapbiomas.org/mapbiomas-cobertura-10m)).
